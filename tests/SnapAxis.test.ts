...
describe("SnapAxis", () => {
  ...
  it("SnapAxis snapTo - 03", () => {
    ...
    const offset = [
      1, 2, 3, 4, 5, 5.1, 5.2, 5.3, 5.4, 5.5, 5.7, 5.9, 6, 7, 8, 10, 11, 22, 25, 40, 55, 70, 80, -1,
      -2, -3, -4, -5, -5.1, -5.2, -5.3, -5.4, -5.5, -5.7, -5.9, -6, -7, -8, -10, -11, -22, -25, -40,
      -55, -70, -80,
    ];
  ...
  it("SnapAxis snapTo - 10", () => {
    const sp = createSnapAxis03();
    {
      expect(
        sp.snapTo(30, 2, {
          distance: 5,
        })
      ).toEqual({ value: 30, snapped: false });
    }
  });

  it("SnapAxis snapTo - 11", () => {
    const sp = createSnapAxis03();
    {
      expect(
        sp.snapTo(35, 1, {
      ...
      ).toEqual({ value: 35, snapped: false });
    }
...

    {
      ...
      ).toEqual({ value: 41, snapped: false });
    }
  });

  it("SnapAxis snapTo - 12", () => {
    const sp = createSnapAxis03();
    {
      expect(
        sp.snapTo(-35, -1, {
